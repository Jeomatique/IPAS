...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:se="http://www.opengis.net/se" version="1.1.0">
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>moyenne</se:Name>
          <se:Description>
            <se:Title>moyenne</se:Title>
          </se:Description>
        ...
        <se:Rule>
          <se:Name>majeur</se:Name>
          <se:Description>
            <se:Title>majeur</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>IMPORTANCE</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>mineur</se:Name>
          <se:Description>
            <se:Title>mineur</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:Or>
              <ogc:PropertyIsEqualTo>
        ...
        <se:Rule>
          <se:Name>peripherique</se:Name>
          <se:Description>
            <se:Title>peripherique</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
